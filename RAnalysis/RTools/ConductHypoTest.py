...
def processLowHighGroups(groupStockReturns, industryReturns):
    ...
    avgGroup, medianGroup = getAvgMedianLowHigh(groupStockReturns)
...
def conductHypoTest(group, models, isLow):
    ...
    if isLow:
        ...
        print('Below average group median return: %6.6f & comparable median return: %6.6f' % (medianGroup, medianIndustry))
        ...
        twoSampleTTest(avgIndustryReturns, avgGroupReturns, False, True)
        ...
        print('Above average group median return: %6.6f & comparable median return: %6.6f' % (medianGroup, medianIndustry))
        tTest1 = ttest_1samp(avgGroupReturns, avgIndustry)
